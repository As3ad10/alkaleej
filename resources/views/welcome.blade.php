<x-app-layout>
    ...
    <section class="py-12">
        <div class="wrapper flex max-w-2xl flex-col gap-8">
            ...
            <p class="text-center">
                قبل إرسال هذا النموذج، يرجى التأكد من تعباة النموذج بشكل صحيح. إذا كنت بحاجة إلى أي مساعدة أو لديك أي
                استفسار، لا تتردد في التواصل معي عبر الرقم التالي: [0500303750].
                أنا هنا لخدمتك.</p>
            <div>
